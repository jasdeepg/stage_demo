...
class EnergyDataControllerTest < ActionController::TestCase
  ...
  test "should create energy_datum" do
    assert_difference('EnergyDatum.count') do
      post :create, energy_datum: { day: @energy_datum.day, hour: @energy_datum.hour, month: @energy_datum.month, power: @energy_datum.power, user_id: @energy_datum.user_id, year: @energy_datum.year }
    end
  ...
  test "should update energy_datum" do
    put :update, id: @energy_datum, energy_datum: { day: @energy_datum.day, hour: @energy_datum.hour, month: @energy_datum.month, power: @energy_datum.power, user_id: @energy_datum.user_id, year: @energy_datum.year }
    assert_redirected_to energy_datum_path(assigns(:energy_datum))
  end
